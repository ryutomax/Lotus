<?php
  session_start();
	...
	$buttonValue = tab_form_value('music');
?>
<main class="l-main p-music">
	...
	<div class="p-articles-head">
		...
		<p class="p-articles-lead">邦楽、洋楽などのミュージックにまつわる<br class="u-sp-show">ニュース、インタビュー、コラムなどをお届け</p>
	</div>
				...
				<article class="p-article">
					<a class="p-article-link" href="<?php echo get_the_permalink(); ?>">
						...
						<figure  class="p-article-frame">
							<img src="<?php print $thumbnail; ?>" alt="<?php the_title(); ?>" class="p-article-thumbnail" load="lazy" loading="lazy">
						</figure>
